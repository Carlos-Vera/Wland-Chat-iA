/**
 * JavaScript para el chat en modo Pantalla Completa
 * 
 * @package WlandChat
 */

// Este archivo es idéntico al modal por ahora
// La diferencia principal está en el CSS
...
(function() {
    ...
    class WlandChat {
        constructor() {
            console.log('Inicializando Wland Chat (Pantalla Completa)...');
